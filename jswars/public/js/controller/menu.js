...
module.exports = function () {
    ...
    var join = function (category, type) {
        ...
        if (!app.game.map()) {
            ...
            else app.game.setMap(app.join[category](type));
    ...
    return {
        ...
        newgame: function () {return join("map","open")},
        continuegame:function () {return join("game","saved");},
        newjoin: function () {return join("game","open");},
        continuejoin: function () {return join("game","running");},

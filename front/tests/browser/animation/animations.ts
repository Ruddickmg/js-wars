...
export default function animations(width, height) {
    ...
    return {
        ...
        hide(): void {transparent = 0.1;},
        cursor(canvas: any, line: DrawingTool): any {

            const
                sizeOfCursorCorners: number = 15,
                distanceBetweenCorners: number = 64,
                widthOfCorner: number = 3,
                distanceToEdges: number = distanceBetweenCorners + widthOfCorner,
                distanceFromEdgeToAdjacentCorner: number = distanceBetweenCorners - sizeOfCursorCorners;

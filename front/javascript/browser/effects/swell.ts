app.settings = require("../configuration/settings/game.js");
...
Sweller.prototype.centerElement = function(center) {
    this.setLeft(this.moveLeft() + center);
    this.setTop(this.top() + center);
};
Sweller.prototype.setLeft = function(position) {this.moveLeft = position;};
Sweller.prototype.moveLeft = function() {return this.moveLeft;};
...
Sweller.prototype.increment = function() {return this.i;};
...
Sweller.prototype.resize = function() {
    ...
    this.element().style.moveLeft = this.moveLeft() + "px";
    return this;
};
...
Sweller.prototype.position = function() {return {x:this.moveLeft(), y:this.top()};};
Sweller.prototype.setPrevious = function(p) {this.position = position; return this;};
Sweller.prototype.previous = function() {return this.position;};

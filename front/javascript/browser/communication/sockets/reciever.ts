...
app.cursor = require('../../controller/cursorController');
app.background = require('../../effects/background');
...
Teams = require('../../menus/teamSelection/teams.js');
unitController = require("../controller/unit.js");

export default function(socket: any): any {
